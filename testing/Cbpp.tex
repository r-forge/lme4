...
## Warning message: no non-missing arguments to min; returning Inf
## Warning message: no non-missing arguments to max; returning -Inf
## Error: Zero breaks in scale for y/ymin/ymax/yend/yintercept/ymin_final/ymax_final
\end{verbatim}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=0.8\textwidth]{figures/Cbpp-lme4-bobyqa} 
...
{\centering \includegraphics[width=0.8\textwidth]{figures/Cbpp-allplot} 
...
{\centering \includegraphics[width=0.8\textwidth]{figures/Cbpp-allplot2} 
