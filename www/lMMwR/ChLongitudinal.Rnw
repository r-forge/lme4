...
\begin{figure}[tbp]
  \centering
<<fm16LambdaL,fig=TRUE,echo=FALSE,results=hide,height=3,width=8>>=
...
\begin{figure}[tbp]
  \centering
<<fm17LambdaL,fig=TRUE,echo=FALSE,results=hide,height=3,width=8>>=
...
\begin{figure}[tbp]
  \centering
<<fm169Zt,fig=TRUE,echo=FALSE,results=hide,height=4,width=8>>=
...
<<pr17plt,fig=TRUE,echo=FALSE,height=3.5>>=
...
\begin{figure}[tbp]
  \centering
<<pr17pairs,fig=TRUE,echo=FALSE,height=8>>=
print(splom(pr17))
@
...
\begin{figure}[tbp]
  \centering
<<ranefcoeffm17,fig=TRUE,echo=FALSE,height=4>>=
