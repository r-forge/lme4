...
@ 
The algorithm converges after 17 function evaluations to a profiled deviance of
\Sexpr{sprintf(.f5, deviance(fm01ML))}
at $\theta=$\Sexpr{sprintf(.f6, fm01ML@re@theta)}.
...
you wish).  The vector $\vec u$ is available in \code{fm01ML@re}.  The
