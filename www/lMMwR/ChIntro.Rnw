...
for analyzing the fitted model.  We describe methods of assessing the
...
REML criterion (explained in Sect.~\ref{sec:REML}).  The
...
of model fits in Sect.~\ref{sec:TestingSig2is0}.
