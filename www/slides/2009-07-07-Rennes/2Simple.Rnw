...
\begin{frame}[fragile]
  ...
  \begin{itemize}
  \item Harold Doran recently fit a linear mixed model to 
    the annual achievement test results for the last 4 years in one of
    the United States.  There were over $5,000,000$ observations in
    total, a total of $n_1=1876788$ students and more the $74000$
    teachers ($n_2$).
  \item The models had simple, scalar random effects for student and
    for teacher so $q>1.95$ million.
