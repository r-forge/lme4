...
\title[Lattice graphics]{Mixed models in R using the lme4 package\\Part 2: lattice graphics in R}
\SweaveOpts{engine=R,eps=FALSE,pdf=TRUE,width=10,height=6.5,strip.white=all}
\SweaveOpts{prefix=TRUE,prefix.string=figs/graphics,include=TRUE}
...
@   
\begin{center}
<<hist,fig=TRUE,echo=FALSE,height=5.5>>=
...
@   
\begin{center}
<<dens,fig=TRUE,echo=FALSE,height=5.5>>=
...
@   
\begin{center}
<<denssqrt,fig=TRUE,echo=FALSE,height=5.5>>=
...
@   
\begin{center}
<<denssqrtfancy,fig=TRUE,echo=FALSE,height=5.5>>=
print(densityplot(~ sqrt(count), InsectSprays,
                  xlab = expression(sqrt("count"))))
@   
\end{center}
...
@   
\begin{center}
<<comparedens,echo=FALSE,fig=TRUE,height=5.5>>=
print(densityplot(~ sqrt(count), InsectSprays,
                  groups = spray,
                  auto.key = list(columns = 6),
                  xlab = expression(sqrt("count"))))
...
@   
\begin{center}
<<comparedenspanel,echo=FALSE,fig=TRUE,height=5.5>>=
...
@   
\begin{center}
<<comparedenspanelleft,echo=FALSE,fig=TRUE,height=5.5>>=
print(densityplot(~ sqrt(count)|spray, InsectSprays,
                  layout = c(1,6), strip=FALSE, strip.left = TRUE,
                  xlab = expression(sqrt("count"))))
@   
...
@   
\begin{center}
<<comparedensreorderpanel,echo=FALSE,fig=TRUE,height=5.5>>=
...
@   
\begin{center}
<<verticalbw,echo=FALSE,fig=TRUE,height=5.5>>=
...
@   
\begin{center}
<<horbw,echo=FALSE,fig=TRUE,height=5.5>>=
...
@   
\begin{center}
<<horreordbw,echo=FALSE,fig=TRUE,height=5.5>>=
...
@   
\begin{center}
<<horbwcomp,echo=FALSE,fig=TRUE,height=3>>=
...
@   
\begin{center}
<<dotspray,echo=FALSE,fig=TRUE,height=4.5>>=
...
\begin{frame}
  \frametitle{ggplot2 -- another advanced graphics system for R}
  \begin{itemize}
  \item Another advanced graphics package for \R{} is \code{ggplot2}
    by Hadley Wickham (a recent Iowa State Stats Ph.D., now at Rice).
  \item His book, \emph{ggplot2: Elegant graphics for Data Analysis},
    is worth examining.
  \item The core chapter introducing the basic function called
    \code{qplot} can be obtained from Hadley's web site \code{had.co.nz}
  \end{itemize}
\end{frame}
\end{document}
